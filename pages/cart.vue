  ...
  <div class="mt-5">
    ...
    <div v-if="products.length > 0">
      <div class="flex justify-between items-center">
        <h1 class="text-2xl mb-4">Product Cart</h1>
        <button
          class="flex justify-center items-center bg-transparent hover:bg-blue-500 text-blue-700 font-semibold py-2 px-4 border border-blue-500 hover:border-transparent rounded"
        >
      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              class="flex w-full items-center justify-end gap-6 max-sm:gap-4"
            >
              <button
